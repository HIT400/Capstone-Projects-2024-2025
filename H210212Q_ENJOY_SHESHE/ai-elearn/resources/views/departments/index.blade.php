    ...
    <div class="px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-6 overflow-x-auto">
            <table class="w-full border-collapse border border-gray-300">
                ...
                <tr>
                    <th class="px-6 py-3 text-left border border-gray-300">Department Name</th>
                    <th class="px-6 py-3 text-left border border-gray-300">Code</th>
                ...
                @foreach ($departments as $department)
                    <tr class="border border-gray-300">
                        <td class="px-6 py-3.5 border border-gray-300">{{ $department->name }}</td>
                        <td class="px-6 py-3.5 border border-gray-300">{{ $department->code }}</td>
                        <td class="px-6 py-3.5 border border-gray-300">{{ $department->status }}</td>
                        <td class="px-6 py-3.5 border border-gray-300">
                            <div class="flex space-x-4">
                                <button onclick="openEditModal({{ $department->id }}, '{{ $department->name }}', '{{ $department->code }}', '{{ $department->status }}')"
